...
using System.Text;
using CvsHealthCare.CqrsMediator.Domain.Exceptions;
using CvsHealthCare.CqrsMediator.Domain.Infrastructure;

namespace CvsHealthCare.CqrsMediator.Domain.ValueObjects
{
